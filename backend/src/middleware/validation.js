...
const validateProfile = [
  ...
  body('minorityStatus').isBoolean().withMessage('Minority community status must be a boolean.'),
  body('disabilityStatus').isBoolean().withMessage('Disability status must be a boolean.'),
  body('isStudent').isBoolean().withMessage('Student status must be a boolean.'),
  body('isFarmer').isBoolean().withMessage('Farmer status must be a boolean.'),
  body('isBusinessOwner').isBoolean().withMessage('Business owner status must be a boolean.'),
  body('bplAplStatus').isIn(['None', 'APL', 'BPL']).withMessage('Invalid Ration Card status.'),
  handleValidationErrors,
];
